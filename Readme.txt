...
注意，本脚本会检测，目标网站是否能正常访问，如果不能正常访问，建议开启VPN，并将目标网站挂载到黑名单中。
...
默认TopGreade只会更新不带有自动更新的APP，需要对TopGrade配置文件进行修改。修改如下：
    ...
    注意：⚠️ 上述这行 启用后，才能让homebrew更新所有APP，如果不开启则指更新不带自动更新的Homebrew APP。
...
===========================================
 ...
 - 本脚本，代码均来自AI，人工仅仅做极少量调整维护。参与编程的AI包括：
   1. 【2025/Q3-？】编程者：OpenAI  ChatGPT O3—Pro + 深度研究 
   2. 【2025/Q1-Q2】编程者：xAI     Grok3 + DeeperThink 
